...
public function insertar(VentaModelo $dato,$idarticulo,$cantidad,$precio_venta,$descuento){
	$sql="INSERT INTO Venta (idcliente,idusuario,tipo_comprobante,serie_comprobante,num_comprobante,fecha_hora,impuesto,total_venta,estado) VALUES ('$dato->idcliente','$dato->idusuario','$dato->tipo_comprobante','$dato->serie_comprobante','$dato->num_comprobante','$dato->fecha_hora','$dato->impuesto','$dato->total_venta','Aceptado')";
...
public function mostrar($idventa){
	$sql="SELECT v.idventa,DATE(v.fecha_hora) as fecha,v.idcliente,p.nombre as cliente,u.idusuario,u.nombre as usuario, v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,v.total_venta,v.impuesto,v.estado FROM Venta v INNER JOIN Cliente_Proveedor p ON v.idcliente=p.idpersona INNER JOIN Usuario u ON v.idusuario=u.idusuario WHERE idventa='$idventa'";
...
public function listar(){
	$sql="SELECT v.idventa,DATE(v.fecha_hora) as fecha,v.idcliente,p.nombre as cliente,u.idusuario,u.nombre as usuario, v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,v.total_venta,v.impuesto,v.estado FROM Venta v INNER JOIN Cliente_Proveedor p ON v.idcliente=p.idpersona INNER JOIN Usuario u ON v.idusuario=u.idusuario ORDER BY v.idventa DESC";
	return ejecutarConsulta($sql);
}
